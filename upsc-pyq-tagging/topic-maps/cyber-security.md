...
## Keywords
cryptography, cyber security, digital signature, PKI, IT Act, authentication, e-governance, VPN, Virtual Private Network, encryption
...
> In India, the term "Public Key Infrastructure" is used in the context of
  ...
  💡 **Eliminate:** Public Key Infrastructure (PKI) is a cryptographic system for managing digital certificates and public-private key pairs — clearly digital security infrastructure.
  📌 **Key facts:**
     - PKI enables secure digital communications through asymmetric cryptography and digital certificates
     - India's PKI is used for Aadhaar, e-Sign, digital signatures in government transactions
...
**[2015]** Q13. Discuss the advantages and security implications of cloud hosting of servers vis-a-vis in-house machine-based hosting for government businesses.
...
**[2013]** Q16. (a) What is a digital signature ? What does its authentication mean ? Give various salient built-in features of a digital signature.
